...
node tools/index/indexer.mjs query "<query>" --strict-fresh
```
...
- `docs/REPO_INDEXING.md`
- `tools/index/index.config.json`
- `tools/index/indexer.mjs`
- `docs/CONTEXT_INDEX.json` command map
- `.github/policies/agent-governance.json` contracts (if required)
