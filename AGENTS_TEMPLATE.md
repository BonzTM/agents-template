...
- Canonical rule catalog: `contracts/rules/canonical-ruleset.json`
- Local rule override schema: `.agent-overrides/rule-overrides.schema.json`
- Optional local rule overrides file: `.agent-overrides/rule-overrides.json`
...
- If process expectations change, update all of:
  ...
  - `.agent-overrides/rule-overrides.schema.json`
  ...
  - `tools/rules/verify-canonical-ruleset.mjs`
