...
const DEFAULT_POLICY_FILE = ".github/policies/agent-governance.json";
const DEFAULT_RULES_FILE = "docs/AGENT_RULES.md";
const DEFAULT_CANONICAL_FILE = "contracts/rules/canonical-ruleset.json";
const DEFAULT_OVERRIDES_SCHEMA_FILE = ".agent-overrides/rule-overrides.schema.json";
const DEFAULT_OVERRIDES_FILE = ".agent-overrides/rule-overrides.json";
