...
- `PLAN.json.narrative.spec_outline`, `PLAN.json.narrative.refined_spec`, and `PLAN.json.narrative.implementation_plan` must be structured objects: `{ "summary": string, "steps": Step[] }`.
