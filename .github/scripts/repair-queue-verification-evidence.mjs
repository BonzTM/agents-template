...
function printHelp() {
  ...
  info("");
  info("Usage:");
  info("  node .github/scripts/repair-queue-verification-evidence.mjs --check");
  info(
    "  node .github/scripts/repair-queue-verification-evidence.mjs --write [--run-cmd \"node .github/scripts/enforce-agent-policies.mjs\"]",
  );
  info("");
  info("Options:");
